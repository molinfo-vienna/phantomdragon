...
mkdir results_reverse_screening_positive
...
do
	...
	do
		...
		do
			...
			do
				python reverse_screening_power.py -c CoreSet.dat -s GAP_Scores/$data$model$add_info$score -l LigandInfo.dat -p 'positive' -o 'GAP-Score' > results_reverse_screening_positive/$data$model$add_info$score.out
