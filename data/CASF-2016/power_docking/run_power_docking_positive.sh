...
mkdir results_power_docking_positive
...
do
	...
	do
		...
		do
			...
			do
				python docking_power.py -c CoreSet.dat -s GAP_Scores/$data$model$add_info$score -r ../decoys_docking/ -p 'positive' -l 2 -o 'GAP-Score' > results_power_docking_positive/$data$model$add_info$score.out 
