...
mkdir results_power_docking_negative
...
do
	...
	do
		...
		do
			...
			do
				python docking_power.py -c CoreSet.dat -s GAP_Scores/$data$model$add_info$score -r ../decoys_docking/ -p 'negative' -l 2 -o 'GAP-Score' > results_power_docking_negative/$data$model$add_info$score.out 
