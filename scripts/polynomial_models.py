...
for k in datatypes:
    for modeltype in modeltypes:
        for score in scoretypes:
            ...
            blub = ph.parameterCollector(add_information="poly",modeltype=modeltype,scoretype=score)
            x_train,x_test,y_train,y_test = ph.prepare_data(score,
                                                            "/data/shared/projects/pharmacophore_hot_spot_analysis/phantomdragon/data/grail_scores_refined_set.csv",
                                                            "/data/shared/projects/pharmacophore_hot_spot_analysis/phantomdragon/data/grail_scores_core_set.csv",
                                                            f"/data/shared/projects/pharmacophore_hot_spot_analysis/phantomdragon/data/PDBbind_refined_set_{k}.csv",
                                                            f"/data/shared/projects/pharmacophore_hot_spot_analysis/phantomdragon/data/PDBbind_core_set_{k}.csv"
                                                            ,"final",
                                                            polynomial=True)
...
df.to_csv("../results/polynomial_models_results.csv")