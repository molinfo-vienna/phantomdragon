...
for k in datatypes:
    for modeltype in modeltypes:
        for score in scoretypes:
            ...
            #
            X_train, X_test, y_train, y_test = ph.prepare_data(score,"./GAP/data/ref_set_grail_descr.csv","./GAP/data/core_set_grail_descr.csv",f"../data/PDBbind_refined_set_{k}.csv","../data/PDBbind_core_set_all.csv","final")
            ...
            plt.savefig(f'../results/learning_curves/{k}_{score}_{modeltype}_final.png')  
...
for k in datatypes:
    for modeltype in modeltypes:
        for score in scoretypes:
            ...
            # Create training and test split
            #
            X_train, X_test, y_train, y_test = ph.prepare_data(score,"../data/PDBbind_refined_set_all_grail_scores.csv","../data/PDBbind_core_set_all_grail_scores.csv",f"../data/PDBbind_refined_set_{k}.csv","../data/PDBbind_core_set_all.csv","GAP")
            ...
            plt.savefig(f'../results/learning_curves/{k}_{score}_{modeltype}_GAP.png')  
