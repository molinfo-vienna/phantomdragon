...
for system in os.listdir("/data/shared/datasets/PL-REX/"):
    if os.path.isdir(f"/data/shared/datasets/PL-REX/{system}") and not system.startswith("."):
        ...
        if system == "004-AR":
            ...
            k2 = "kd"
            k = "kd"
        elif system == "009-CDK2":
            modeltype2 = "SVR"
            modeltype = "XGBoost"
            score = "delta G"
            k2 = "all"
            k = "ki"
        elif system == "008-Trypsin":
            modeltype2 = "linearRegression"
            modeltype = "ElasticNet"
            score = "delta G"
            k2 = "kd"
            k = "ki"
        elif system == "001-CA2":
            modeltype2 = "RandomForest"
            ...
            k2 = "ki"
            k = "all"
        elif system == "010-MMP12":
            modeltype2 = "XGBoost"
            modeltype = "SVR"
            score = "delta G"
            k2 = "all"
            k = "kd"
        elif system == "005-Cath-D":
            modeltype2 = "ElasticNet"
            modeltype = "Ridge"
            score = "delta G"
            k2 = "kd"
            k = "kd"
        elif system == "007-JAK1":
            modeltype2 = "linearRegression"
            modeltype = "SVR"
            score = "delta G"
            k2 = "kd"
            k = "kd"
        elif system == "006-BACE1-D3R":
            modeltype2 = "ElasticNet"
            modeltype = "Lasso"
            score = "delta G"
            k2 = "kd"
            k = "kd"
        elif system == "002-HIV-PR":
            modeltype2 = "SVR"
            modeltype = "SVR"
            score = "delta G"
            k2 = "kd"
        ...
        blub = ph.parameterCollector(add_information="GRADE",modeltype=modeltype2,scoretype=score)
        x_train,x_test,y_train,y_test = ph.prepare_data(score,"../../GAP/data/ref_set_descrs.csv","/data/shared/projects/pharmacophore_hot_spot_analysis/phantomdragon/data/GRAIL-scores/PDBbind_general_set_grail_scores_slim.csv",f"../data/PDBbind_refined_set_{k2}.csv",f"../data/experiments/general_set.csv","GRADE")
        blub.set_trainingdata(x_train,y_train)
        ...
        blub.set_testingdata(x_test,y_test)
        blub.set_datatype(f"{k2}")
        # blub.train_and_save_model(savepath="../models/")
        blub.phantomtest(loadpath="../models/")
        modeltype,scoret,datatype,mae,mse,sd,pearsonr,confidence_interval,r_2,spearman_r,add_info = blub.get_stats(spearman=True)
        blub.plot_phantomtest("../plots/",name=f"{system}_{modeltype2}_{scoret}_{datatype}_{add_info}_charged")
        modeltype_list.append(modeltype2)
        scoretype_list.append(scoret)
        datatype_list.append(datatype)
        mae_list.append(mae)
        mse_list.append(mse)
