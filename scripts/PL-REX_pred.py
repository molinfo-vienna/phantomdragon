        ...
        for k in datatypes:
            for modeltype in modeltypes:
                for score in scoretypes:
                    ...
                    df_desc = pd.read_csv(f"/data/shared/datasets/PL-REX/{system}/structures_pl-rex/X-GRADE.csv")
                    ...
                    blub.plot_phantomtest("../plots/",name=f"{system}_{modeltype}_{scoret}_{datatype}_{add_info}")
        ...
        for k in datatypes:
            for modeltype in modeltypes:
                for score in scoretypes:
                    ...
                    df_desc = pd.read_csv(f"/data/shared/datasets/PL-REX/{system}/structures_pl-rex/GRADE.csv")
                    df_desc = df_desc.sort_values(by='PDB code')
                    df_desc.reset_index(drop=True, inplace=True)
...
df.to_csv("../results/PL-REX_results.csv")