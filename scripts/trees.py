...
for k in datatypes:
    for modeltype in modeltypes:
        for score in scoretypes:
            ...
            x_train,x_test,y_train,y_test = ph.prepare_data(score,"../data/PDBbind_refined_set_all_grail_scores.csv","../data/PDBbind_core_set_all_grail_scores.csv",f"../data/PDBbind_refined_set_{k}.csv",f"../data/PDBbind_core_set_{k}.csv","final")
